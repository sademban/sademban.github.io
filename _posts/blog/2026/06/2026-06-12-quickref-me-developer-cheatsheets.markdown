...
description: A short note on using quickref.me and cheatsheets.zip for quick developer
  references, with examples for Python, regex, Git, and Docker.
...
image_alt: Dark developer desk illustration with the text quickref.me surrounded by
  small code reference panels
image_caption: quickref.me works best as a quick reminder when the syntax is almost
  in your head.
