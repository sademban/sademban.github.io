...
description: Notes from publishing TOON FMTR, a VS Code extension for TOON syntax
  highlighting, formatting, JSON conversion, settings, and safer auto-convert behavior.
...
image_alt: Sketch-style illustration with TOON FMTR text, the extension logo, and
  JSON to TOON conversion cards
image_caption: TOON FMTR adds syntax highlighting, formatting, and JSON conversion
  for TOON files.
