...
- [Aditya Thebe Limbu](https://adityathebe.com/) — writes about tooling, infrastructure, and experimenting with Go.
- [Mitchell Hashimoto](https://mitchellh.com/) — co-founder of HashiCorp; shares deep dives into developer tooling and startups.
- [Thorsten Ball](https://thorstenball.com/) — author exploring interpreters, compilers, and craft-focused engineering.
